...
```bash
node skill/ppt-maker/scripts/ppt-maker.js -i input.md -o output.pptx -t ocean
```
...
```bash
# 查看帮助
node skill/ppt-maker/scripts/ppt-maker.js -h

# 列出所有主题
node skill/ppt-maker/scripts/ppt-maker.js -l

# 海洋蓝主题（默认）
node skill/ppt-maker/scripts/ppt-maker.js -i slides.md -o demo.pptx

# 深夜科技主题
node skill/ppt-maker/scripts/ppt-maker.js -i slides.md -o demo.pptx -t midnight

# 黑金奢华主题
node skill/ppt-maker/scripts/ppt-maker.js -i slides.md -o demo.pptx -t luxury
```
...
- 脚本：`skill/ppt-maker/scripts/ppt-maker.js`
- 依赖：`pptxgenjs`（已安装）
